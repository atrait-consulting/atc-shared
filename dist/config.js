...
export const idUrl = () => required(ID_URL, 'NEXT_PUBLIC_ATC_ID_URL');
/** Clé anonyme du projet `atc-platform`. Publique par nature, jamais la service_role. */
export const idAnonKey = () => required(ID_ANON_KEY, 'NEXT_PUBLIC_ATC_ID_ANON_KEY');
/**
...
export const appLabel = (slug) => `MC ${slug.toUpperCase()}`;
